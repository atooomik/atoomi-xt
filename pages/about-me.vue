  ...
  <section class="sln-gp-grad lg:h-screen">
    <div class="contain flex flex-col items-start min-h-adjust lg:flex-row">
      <div class="hidden lg:block lg:h-full lg:w-1/4">
        <div class="traslate-shadow-entrance overflow-hidden h-72 lg:mt-40 rounded-lg">
          <img
        ...
        <div class="w-full flex justify-center my-6 text-3xl text-white">
          <fa-icon class="m-4 opacity-icon-entrance" :icon="['fad', 'cat-space']" />
          <fa-icon class="m-4 opacity-icon-entrance" :icon="['fas', 'game-console-handheld']" />
          <fa-icon class="m-4 opacity-icon-entrance" :icon="['fad', 'mountain']" />
        </div>
      </div>
      <div
