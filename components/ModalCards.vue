<template>
  <div>
    <div class="modal-card" @click="showModal()">
      <img :src="imgSrc" alt />
      <p v-text="proyectTitle" class="text-white px-4 py-2"></p>
    </div>
    ...
    <transition name="traslate">
      <div v-if="openOverlay">
        ...
        >
          <div class="relative max-w-4xl mx-auto lg:mt-16 rounded-lg cursor-default">
            <button
              class="absolute z-10 right-0 bottom-0 left-0 mx-auto -mb-4 px-1 pt-1 bg-white rounded-full"
              @click="showModal()"
            >
              <fa-icon class="text-black text-2xl" :icon="['fad', 'times-circle']" />
            </button>
            <div class="w-full h-80 rounded-lg lg:h-84 bg-white overflow-y-scroll">
              <div class="w-full">
              ...
              <div v-if="cardLang === 'español'" class="w-full p-4">
                ...
                <div class="mb-4">
                  <p class="font-normal">Participación:</p>
                  <p v-text="proyectTasks"></p>
                </div>
                <div class="mb-4">
                  <p class="font-normal">Retos:</p>
                  <p v-text="proyectChallenges"></p>
                </div>
                <div class="mb-4">
                  <p class="font-normal">Principales tecnologias utilizadas en el proyecto:</p>
                  <div class="grid grid-cols-4 justify-items-center text-3xl text-atoom-semiGray">
              ...
              <div v-if="cardLang === 'english'" class="w-full p-4">
                ...
                <div class="mb-4">
                  <p class="font-normal">My participation:</p>
                  <p v-text="proyectTasks"></p>
                </div>
                <div class="mb-4">
                  <p class="font-normal">The challenges:</p>
                  <p v-text="proyectChallenges"></p>
                </div>
                <div class="mb-4">
                  <p class="font-normal">Main technologies used on the project:</p>
                  <div class="grid grid-cols-4 justify-items-center text-3xl text-atoom-semiGray">
                    <slot name="tecnologies"></slot>
                  </div>
                </div>
